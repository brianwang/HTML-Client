  ...
  <div>
    ...
    <div data-ng-show="doneLoading">
      ...
      <form>
        ...
        <input data-ng-click="saveDeck()" type="submit" value="Save Deck" className="btn btn-xs btn-primary"/>
        <br/>
        <input data-ng-show="enteringGame" data-ng-click="enterGame()" type="button" value = "Start game" className="btn btn-sm btn-success"/>
        <input data-ng-hide="enteringGame" data-ng-click="goBack()" type="button" value="Go back to lobby" className="btn btn-sm btn-default"/>
      </form>
      ...
      <ul>
        <li data-ng-repeat="deck in savedDecks">
          ...
          <input data-ng-click="deleteDeck(deck.name)" type="button" value="Delete" className="btn btn-xs btn-danger"/>
        </li>
      </ul>
